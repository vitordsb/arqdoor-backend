...
const getOneTicketController = require("../controllers/ticketService/getOneTicketController"); // Changed from getTicketController
const updateTicketController = require("../controllers/ticketService/updateTicketController"); // Changed from controllers/tickets/updateTicketController
const updateTicketValidator = require("../middlewares/validators/ticketService/updateTicketValidator"); // New import
const approveGroupController = require("../controllers/tickets/approveGroupController");
